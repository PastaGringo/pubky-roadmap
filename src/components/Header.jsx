      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          >
            ...
            <div>
              <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Pubky RoadMap</h1>
              <p className="text-sm text-slate-600 dark:text-slate-400">Vote for the future of Pubky ecosystem</p>
            </div>
          </div>
